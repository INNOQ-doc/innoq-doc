...
If you have a multi-Agent chatbot setup, GPT-trainer uses an AI Supervisor to automatically 
...
First, you need a regular “Lead Collection” setup described in our [Lead Collection] article. Once you 
...
Now, since you don’t want users to get stuck in Lead Collection Agent, go back to its settings. Under 
“Variables / Tags” turn off “Required Variables”:

<Frame>
  <img src="/images/supervisor-overrides-4.png" />
</Frame>

Save your Agent. Next, since you want your chatbot to serve users normally when they first engage with it, 
set the General Q&A Agent to be your “Initial Agent”.
