...
api: "POST https://app.innochat.ch/api/v1/chatbot/<uuid>/source-tag/create"
description: "Create a source tag for a chatbot. Source tags can be used to organize sources."
---
...
```bash Curl
curl --location --request POST 'https://app.innochat.ch/api/v1/chatbot/<uuid>/source-tag/create' \
...
url = 'https://app.innochat.ch/api/v1/chatbot/<uuid>/source-tag/create'
headers = {
...
const url =
  "https://app.innochat.ch/api/v1/chatbot/{uuid}/source-tags/create";
const headers = {
  "Content-Type": "application/json",
  Authorization: "Bearer <token>",
};
