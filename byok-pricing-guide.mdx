...
continue to be able to use AI features. New subscriptions does not come with monthly recurring MCs. However, 
...
<Note>
  As of April 2024, GPT-trainer still uses gpt-3.5-turbo-0613 for GPT-3.5. This is because based on our internal benchmarks, this model 
