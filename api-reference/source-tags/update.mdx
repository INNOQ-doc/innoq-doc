...
api: "POST https://app.innochat.ch/api/v1/source-tag/<uuid>/update"
...
```bash Curl
curl --location --request POST 'https://app.innochat.ch/api/v1/source-tag/<uuid>/update' \
...
url = 'https://app.innochat.ch/api/v1/source-tag/<uuid>/update'
headers = {
...
const url = "https://app.innochat.ch/api/v1/source-tag/<uuid>/update";
const headers = {
  "Content-Type": "application/json",
  Authorization: "Bearer <token>",
};
