---
title: "Fetch the list of Sources"
api: "GET https://app.gpt-trainer.com/api/v1/chatbot/{uuid}/data-sources"
...
url = 'https://app.gpt-trainer.com/api/v1/chatbot/{uuid}/data-sourcese'
headers = {
...
const url = 'https://app.gpt-trainer.com/api/v1/chatbot/{uuid}/data-sources';
const headers = {
    'Authorization': 'Bearer <token>'
};
