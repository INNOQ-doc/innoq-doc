---
title: "Delete the list of Sources"
api: "POST https://app.gpt-trainer.com/api/v1/data-sources/delete"
...
const url = 'https://app.gpt-trainer.com/api/v1/data-sources/delete';
const headers = {
    'Content-Type': 'application/json',
    'Authorization': 'Bearer <token>'
};;
