...
api: "GET https://app.gpt-trainer.com/api/v1/chatbot/{uuid}/agents"
...
```bash Curl
curl --location --request GET 'https://app.gpt-trainer.com/api/v1/chatbot/{uuid}/agents' \
...
const url = `https://app.gpt-trainer.com/api/v1/chatbot/${uuid}/agents`;
const headers = {
    'Authorization': 'Bearer <token>'
};
