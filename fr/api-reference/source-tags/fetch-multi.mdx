...
api: "GET https://app.innochat.ch/api/v1/chatbot/<uuid>/source-tags"
description: "List all source tags for a chatbot."
---
...
<RequestExample>
```bash Curl
curl --location --request GET 'https://app.innochat.ch/api/v1/chatbot/{uuid}/source-tags' \
...
uuid = '<chatbot-uuid>'
url = f'https://app.innochat.ch/api/v1/chatbot/{uuid}/source-tags'
headers = {
...
const url = `https://app.innochat.ch/api/v1/chatbot/${uuid}/source-tags`;
const headers = {
  Authorization: "Bearer <token>",
};
