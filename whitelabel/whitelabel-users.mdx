...
description: Learn how to view your app's users, check their usage, access accounts, and securely manage or delete user accounts in the INNOCHAT white label dashboard.
---

Through your [whitelabel dashboard](https://partners.innochat.ch), you will be able to inspect all the users of your app. You can do this in the "Clients" tab. 
