...
Once you have completed the review process, your Make.com app should have an associated public invitation link. For example, GPT-trainer's Make.com link is: [https://www.make.com/en/hq/app-invitation/066096884188bc6b173953df718d8808](https://www.make.com/en/hq/app-invitation/066096884188bc6b173953df718d8808). You can paste this link into the Partners Dashboard once it's ready.

Finally, Make.com and Zapier integrations share the same metadata property in your Stripe plan permissions. Please set the `zapier_integration` boolean to True to enable it for your desired plans.