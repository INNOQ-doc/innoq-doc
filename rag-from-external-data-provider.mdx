...
Finally, we get to variable parameters. This is where you tell the LLM, in a structured fashion, how to provide input to the function you defined. Make sure to follow 
...
The function can only be called once the "required" parameters have been collected. If necessary information is missing, the function cannot be executed. You 
