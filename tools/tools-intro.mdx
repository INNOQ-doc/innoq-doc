---
title: Introduction
description: This introduction explains how to use INNOCHAT tool functions with function calling, create your own API keys, and integrate frequently used tools such as the Weekday Service. Learn how to integrate APIs, set up authentication correctly, and efficiently expand your chatbot functions.
---
