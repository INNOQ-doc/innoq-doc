...
assistance in the background by **setting variables, assigning tags, or calling functions** when certain criteria are met.
...
Like user-facing Agents, background Agents can set Variables. The setup works the same way for both types of Agents.
For an example of how to set Variables using Agents, see [Lead Collection](/lead-collection)
