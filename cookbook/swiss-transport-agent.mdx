...
**Agent Name:** `Swiss Transport Assistant`
...
Since it's basic agent creation with single LLM call, we can skip the Knowledge section and also uncheck the all sources parameter.
...
<Frame>
  <img src="/images/swiss-transport-agent-function-1.png" />
</Frame>
