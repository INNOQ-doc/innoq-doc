...
### ⚙️ **Intermediate**
> One Agent per Chatbot with two Function Calls  
Combine different APIs within one chatbot (e.g., News Agent with getHeadlines,and searchTopic).

### 🧠 **Advanced**
> Multiple Agents/Single Agent per Chatbot with Multiple Function Calls  
Orchestrate multiple specialized agents (e.g., Swiss Tourism Agent) inside one chatbot.
