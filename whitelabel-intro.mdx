...
- Your website URL (preferably separate from the address of your app. For example, the GPT-Trainer website is [https://gpt-trainer.com/](https://gpt-trainer.com/), while the GPT-Trainer app is hosted at [https://app.gpt-trainer.com](https://app.gpt-trainer.com))
